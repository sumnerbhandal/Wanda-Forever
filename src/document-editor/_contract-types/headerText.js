...
const DefaultContract = (
  ...
  >
    ...
    <p>
      ...
      <span className="placeholder">[Month]</span> 2020 (the “Effective Date”),
      by and between, on the one hand,{" "}
    ...
    <p>
      Recipient and <span className="placeholder">[X]</span> may be referred to
    ...
    <p>
      ...
      nature, in connection with a potential financing transaction, either in
      equity or debt format, for the acquisition and subsequent promotion of a
      site in <span className="placeholder">[•]</span> (hereinafter, the
      "transaction").
    </p>
      ...
      <li>
        ...
        <ol>
          <li>
            ...
            transmission via electronic media, (ii) visual information and (iii)
            oral information
          </li>
          <li>
            ...
            <ol type="a">
              <li>
                ...
                employees, officers, directors, attorneys and accountants, each
                of whom need to know the Confidential Information to assist the
                Recipient, (ii) is informed by the Recipient of the confidential
                nature of the Confidential Information and (iii) agrees to be
                bound by this Agreement or otherwise is subject to
                confidentiality duties or obligations to the Recipient that are
                no less restrictive than the terms and conditions of this
                Agreement;
              </li>
              <li>
                ...
                organization, entity or governmental or judicial authority,
                agency, body or tribunal; and
              </li>
            </ol>
          </li>
        </ol>
      ...
      <li>
        ...
        <ol>
          ...
          <li>
            ...
            Recipient gives the Disclosing Party reasonable notice prior to such
            disclosure and (ii) the Recipient reasonably complies with any
            applicable protective order or equivalent (iii) the Recipient
            discloses no more than that portion of the Confidential Information
            which, on the advice of the Recipient’s legal counsel, is legally
            required to be disclosed and, (iv) upon the Disclosing Party’s
            request, shall use commercially reasonable efforts to obtain
          ...
          <li>
            ...
            subcontractors and entities controlled by the Recipient or hired or
            engaged by the Recipient who have a legitimate need to know the
          ...
          <li>
            ...
            Agreement, in which event, such Person shall be deemed the Recipient
            for all purposes hereunder, and each of such Person’s
